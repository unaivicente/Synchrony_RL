...
EEG = pop_loadset('filename',S(suje).name,'filepath','/Users/unaiv/Documents/NEWGAMMA');
EEG = pop_chanedit(EEG, 'load',{'/Users/unaiv/Documents/NEWGAMMA/canales_laplacian.ced' 'filetype' 'autodetect'});
...
SANGD4=squeeze(ANGD(4:8,2561:3073,:,:));
SANGC4=squeeze(ANGC(4:8,2561:3073,:,:));
SANGS4=squeeze(ANGS(4:8,2561:3073,:,:));

SANGD8=squeeze(ANGD(8:12,2561:3073,:,:));
SANGC8=squeeze(ANGC(8:12,2561:3073,:,:));
SANGS8=squeeze(ANGS(8:12,2561:3073,:,:));

SANGD13=squeeze(ANGD(13:25,2561:3073,:,:));
SANGC13=squeeze(ANGC(13:25,2561:3073,:,:));
SANGS13=squeeze(ANGS(13:25,2561:3073,:,:));

SANGD38=squeeze(ANGD(38:42,2561:3073,:,:));
SANGC38=squeeze(ANGC(38:42,2561:3073,:,:));
SANGS38=squeeze(ANGS(38:42,2561:3073,:,:));

%With ERP

SANGD4_N=squeeze(ANGD_N(4:8,2561:3073,:,:));
SANGC4_N=squeeze(ANGC_N(4:8,2561:3073,:,:));
SANGS4_N=squeeze(ANGS_N(4:8,2561:3073,:,:));

SANGD8_N=squeeze(ANGD_N(8:12,2561:3073,:,:));
SANGC8_N=squeeze(ANGC_N(8:12,2561:3073,:,:));
SANGS8_N=squeeze(ANGS_N(8:12,2561:3073,:,:));

SANGD13_N=squeeze(ANGD_N(13:25,2561:3073,:,:));
SANGC13_N=squeeze(ANGC_N(13:25,2561:3073,:,:));
SANGS13_N=squeeze(ANGS_N(13:25,2561:3073,:,:));

SANGD38_N=squeeze(ANGD_N(38:42,2561:3073,:,:));
SANGC38_N=squeeze(ANGC_N(38:42,2561:3073,:,:));
SANGS38_N=squeeze(ANGS_N(38:42,2561:3073,:,:));
