...
EEGS1 = pop_loadset('filename',S(suje).name,'filepath','/Users/unaiv/Desktop/Analysis 2/Data/');
EEGS1 = pop_chanedit(EEGS1, 'load',{'/Users/unaiv/Desktop/Analysis 2/Data/canales_laplacian.ced' 'filetype' 'autodetect'});

EEGS2 = pop_loadset('filename',S(suje+1).name,'filepath','/Users/unaiv/Desktop/Analysis 2/Data/');
EEGS2 = pop_chanedit(EEGS2, 'load',{'/Users/unaiv/Desktop/Analysis 2/Data/canales_laplacian.ced' 'filetype' 'autodetect'});
...
%Theta
SANGD1=ANGD_S1(4:8,2049:2561,:,:);
SANGD2=ANGD_S2(4:8,2049:2561,:,:);
 
SANGD1_N=ANGD_S1_N(4:8,2049:2561,:,:);
SANGD2_N=ANGD_S2_N(4:8,2049:2561,:,:);
%Alpha
SANGD3=ANGD_S1(8:13,2049:2561,:,:);
SANGD4=ANGD_S2(8:13,2049:2561,:,:);

SANGD3_N=ANGD_S1_N(8:13,2049:2561,:,:);
SANGD4_N=ANGD_S2_N(8:13,2049:2561,:,:);
%Beta
SANGD5=ANGD_S1(13:25,2049:2561,:,:);
SANGD6=ANGD_S2(13:25,2049:2561,:,:);

SANGD5_N=ANGD_S1_N(13:25,2049:2561,:,:);
SANGD6_N=ANGD_S2_N(13:25,2049:2561,:,:); 
%Gamma
SANGD7=ANGD_S1(25:42,2049:2561,:,:);
SANGD8=ANGD_S2(25:42,2049:2561,:,:);

SANGD7_N=ANGD_S1_N(25:42,2049:2561,:,:);
SANGD8_N=ANGD_S2_N(25:42,2049:2561,:,:);
...
%Theta
SANGC1=ANGC_S1(4:8,2049:2561,:,:);
SANGC2=ANGC_S2(4:8,2049:2561,:,:);
 
SANGC1_N=ANGC_S1_N(4:8,2049:2561,:,:);
SANGC2_N=ANGC_S2_N(4:8,2049:2561,:,:);
%Alpha
SANGC3=ANGC_S1(8:13,2049:2561,:,:);
SANGC4=ANGC_S2(8:13,2049:2561,:,:);

SANGC3_N=ANGC_S1_N(8:13,2049:2561,:,:);
SANGC4_N=ANGC_S2_N(8:13,2049:2561,:,:);
%Beta
SANGC5=ANGC_S1(13:25,2049:2561,:,:);
SANGC6=ANGC_S2(13:25,2049:2561,:,:);

SANGC5_N=ANGC_S1_N(13:25,2049:2561,:,:);
SANGC6_N=ANGC_S2_N(13:25,2049:2561,:,:); 
%Gamma
SANGC7=ANGC_S1(25:42,2049:2561,:,:);
SANGC8=ANGC_S2(25:42,2049:2561,:,:);

SANGC7_N=ANGC_S1_N(25:42,2049:2561,:,:);
SANGC8_N=ANGC_S2_N(25:42,2049:2561,:,:);
...
%Theta
SANGS1=ANGS_S1(4:8,2049:2561,:,:);
SANGS2=ANGS_S2(4:8,2049:2561,:,:);
 
SANGS1_N=ANGS_S1_N(4:8,2049:2561,:,:);
SANGS2_N=ANGS_S2_N(4:8,2049:2561,:,:);
%Alpha
SANGS3=ANGS_S1(8:13,2049:2561,:,:);
SANGS4=ANGS_S2(8:13,2049:2561,:,:);

SANGS3_N=ANGS_S1_N(8:13,2049:2561,:,:);
SANGS4_N=ANGS_S2_N(8:13,2049:2561,:,:);
%Beta
SANGS5=ANGS_S1(13:25,2049:2561,:,:);
SANGS6=ANGS_S2(13:25,2049:2561,:,:);

SANGS5_N=ANGS_S1_N(13:25,2049:2561,:,:);
SANGS6_N=ANGS_S2_N(13:25,2049:2561,:,:); 
%Gamma
SANGS7=ANGS_S1(25:42,2049:2561,:,:);
SANGS8=ANGS_S2(25:42,2049:2561,:,:);

SANGS7_N=ANGS_S1_N(25:42,2049:2561,:,:);
SANGS8_N=ANGS_S2_N(25:42,2049:2561,:,:);
